...
define('springboot/tests/lint/templates.template.lint-test', [], function () {
  'use strict';

  QUnit.module('TemplateLint');

  QUnit.test('springboot/templates/application.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'springboot/templates/application.hbs should pass TemplateLint.\n\n');
  });
...
define('springboot/tests/test-helper', ['springboot/app', 'springboot/config/environment', '@ember/test-helpers', 'ember-qunit'], function (_app, _environment, _testHelpers, _emberQunit) {
  'use strict';
...
define('springboot/tests/unit/adapters/application-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('springboot/tests/unit/models/comment-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
...
define('springboot/config/environment', [], function() {
  var prefix = 'springboot';
try {
...
require('springboot/tests/test-helper');
